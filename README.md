...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-27 21:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9b7f8b9d-edf5-49a8-b4d4-b7173db600cf.git
$ cd 9b7f8b9d-edf5-49a8-b4d4-b7173db600cf
```
